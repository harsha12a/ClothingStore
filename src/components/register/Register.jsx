    ...
    <div className="container mt-5">
      ...
      <div className="row">
        <form
          ...
          className="col-sm-10 col-md-6 col-lg-4 m-auto"
        >
          <div className="mb-3">
            ...
            <input
              ...
              className="form-control norfont"
              placeholder="Enter your name"
            />
            {errors.name?.type === "required" && (
              <p className="text-danger norfont">*Name is required</p>
            )}
          </div>
          <div className="mb-3">
            ...
            {errors.email?.type === "required" && (
              <p className="text-danger norfont">*Email is required</p>
            )}
          </div>
          <div className="mb-3">
            ...
            {errors.contact?.type === "required" && (
              <p className="text-danger norfont">*Contact no. is required</p>
            )}
            {errors.contact?.type === "minLength" && (
              <p className="text-danger norfont">
          ...
          <div className="mb-3">
            ...
            {errors.username?.type === "required" && (
              <p className="text-danger norfont">*Username is required</p>
            )}
          </div>
          <div className="mb-3">
            ...
            {errors.password?.type === "required" && (
              <p className="text-danger norfont">*Password is required</p>
            )}
          </div>
          <div className="mb-3">
